...
{
    internal static class SnappyDecompressor
    {
        ...
        public static int Decompress(byte[] input, int inputOffset, int inputSize, byte[] output, int outputOffset, int outputLimit)
        {
